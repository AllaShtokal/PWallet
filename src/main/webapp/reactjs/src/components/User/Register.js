                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        ...
                                        <FormControl required autoComplete="off" type="text" name="login" value={login} onChange={this.userChange}
                            ...
                            <Form.Row>
                                <Form.Group as={Col}>
                                    <InputGroup>
                                        ...
                                        <FormControl required autoComplete="off" type="password" name="password2" value={password2} onChange={this.userChange}
                                                     className={"bg-dark text-white"} placeholder="Enter Password One More Time"/>
                                    </InputGroup>
                                </Form.Group>
                            </Form.Row>
